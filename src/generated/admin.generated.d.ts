...
export type GetAssignedFulfillmentOrdersQuery = { shop: { assignedFulfillmentOrders: { nodes: Array<(
        ...
        & { destination?: AdminTypes.Maybe<Pick<AdminTypes.FulfillmentOrderDestination, 'firstName' | 'lastName' | 'address1' | 'address2' | 'city' | 'zip' | 'province' | 'countryCode' | 'phone' | 'email'>>, lineItems: { nodes: Array<Pick<AdminTypes.FulfillmentOrderLineItem, 'id' | 'sku' | 'totalQuantity'>> }, merchantRequests: { nodes: Array<Pick<AdminTypes.FulfillmentOrderMerchantRequest, 'message'>> } }
      )> } } };
